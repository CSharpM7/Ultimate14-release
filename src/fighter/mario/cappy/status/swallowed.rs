...
pub fn install(agent: &mut smashline::Agent) {  
    agent.status(Init, mario_cappy::CAPTOSS_STATUS_KIND_SWALLOWED, captoss_swallowed_init);
    agent.status(Pre, mario_cappy::CAPTOSS_STATUS_KIND_SWALLOWED, captoss_swallowed_pre);
    agent.status(Main, mario_cappy::CAPTOSS_STATUS_KIND_SWALLOWED, captoss_swallowed_main);
    agent.status(Exec, mario_cappy::CAPTOSS_STATUS_KIND_SWALLOWED, captoss_swallowed_exec);
    agent.status(End, mario_cappy::CAPTOSS_STATUS_KIND_SWALLOWED, captoss_swallowed_end);
}
