...
pub fn install(agent: &mut smashline::Agent) {  
    agent.status(Init, mario_cappy::CAPTOSS_STATUS_KIND_POCKET, captoss_pocket_init);
    agent.status(Pre, mario_cappy::CAPTOSS_STATUS_KIND_POCKET, captoss_pocket_pre);
    agent.status(Main, mario_cappy::CAPTOSS_STATUS_KIND_POCKET, captoss_pocket_main);
    agent.status(End, mario_cappy::CAPTOSS_STATUS_KIND_POCKET, captoss_pocket_end);
}
