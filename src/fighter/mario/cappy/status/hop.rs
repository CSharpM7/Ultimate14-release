...
pub fn install(agent: &mut smashline::Agent) {  
    agent.status(Init, mario_cappy::CAPTOSS_STATUS_KIND_HOP, captoss_hop_init);
    agent.status(Pre, mario_cappy::CAPTOSS_STATUS_KIND_HOP, captoss_hop_pre);
    agent.status(Main, mario_cappy::CAPTOSS_STATUS_KIND_HOP, captoss_hop_main);
    agent.status(Exec, mario_cappy::CAPTOSS_STATUS_KIND_HOP, captoss_hop_exec);
    agent.status(End, mario_cappy::CAPTOSS_STATUS_KIND_HOP, captoss_hop_end);
}
